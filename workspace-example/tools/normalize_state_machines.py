...
# Legacy utility, currently unused by the active pipeline.
# Marked for deletion in cleanup review.
WORKSPACE_ROOT = Path(os.environ.get("WORKSPACE_ROOT", Path(__file__).resolve().parent))
PATH = WORKSPACE_ROOT / "workspace-example" / "bundles" / "domain" / "state_machines.json"
