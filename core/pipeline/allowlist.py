#!/usr/bin/env python3
"""
Allowlist validator for normalized iteration payloads.
Fail closed if Iteration tries to touch any file path not in the canonical allowlist.

Usage:
  allowlist.py --allowlist contracts/allowlists/canonical_pack_paths.txt --normalized normalized.json
